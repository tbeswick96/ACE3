...
[QGVAR(shortEnvelopeDigTime), "SLIDER", localize LSTRING(STR_ACE_Trenches_ShortEnvelopeDigTime), localize LSTRING(settingCategory), [5, 300, 15, 0]] call CBA_Settings_fnc_init;
[QGVAR(shortEnvelopeRemovalTime), "SLIDER", localize LSTRING(STR_ACE_Trenches_ShortEnvelopeDigTime), localize LSTRING(settingCategory), [5, 300, 10, 0]] call CBA_Settings_fnc_init;
