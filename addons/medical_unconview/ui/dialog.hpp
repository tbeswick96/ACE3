class GVAR(uncon) {
    ...
    onUnload = QUOTE(call FUNC(onDialogUnload));
    ...
    class Controls {
        ...
        class PiPZone {
            ...
            text = "#(argb,512,512,1)r2t(ace_medical_unconview_rtt,1.333)";
            moving = 0;
        };
        ...
        class spc_nvg_0 {
            ...
            soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1};
            soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1};
            onButtonDown = "'ace_medical_unconview_rtt' setPiPEffect [0]";
        };
        class spc_nvg_1: spc_nvg_0 {
            idc = IDC_SPEC_NVG_1;
            x = QUOTE(17.5 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X);
            text = "Night Vision";
            onButtonDown = "'ace_medical_unconview_rtt' setPiPEffect [1]";
        };
        class spc_nvg_2: spc_nvg_0 {
            idc = IDC_SPEC_NVG_2;
            x = QUOTE(23 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X);
            text = "Thermal";
            onButtonDown = "'ace_medical_unconview_rtt' setPiPEffect [2]";
        };
        ...
        class spc_BloodVol: spc_HeartRate {
            idc = IDC_HEALTH_BLOODVOL;
            y = QUOTE(16 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y);
        };
        class spc_Pain: spc_HeartRate {
            idc = IDC_HEALTH_PAIN;
            y = QUOTE(19 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y);
        };
        class spc_cr_timer: spc_HeartRate {
            idc = IDC_HEALTH_STATE_TIMER;
            x = QUOTE(10 * GUI_GRID_CENTER_W + GUI_GRID_CENTER_X);
            y = QUOTE(23 * GUI_GRID_CENTER_H + GUI_GRID_CENTER_Y);
            w = QUOTE(20 * GUI_GRID_CENTER_W);
            h = QUOTE(1.6 * GUI_GRID_CENTER_H);
            size = QUOTE(GUI_GRID_CENTER_H * 1.4);
