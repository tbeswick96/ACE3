...
#define PROXIMITY_DEBUG_DRAW_TTL_DETONATION 5
#define PROXIMITY_DEBUG_DRAW_TTL_DIRECT_HIT 3
#define PROXIMITY_ACCEL_EMA_ALPHA 0.3
#define PROXIMITY_CHECK_DISTANCE_FACTOR 3
